...
function LinkedinIcon() {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
      style={{ width: "clamp(24px, 4.57vw, 62px)", height: "clamp(24px, 4.57vw, 62px)" }}
    >
    ...
    <div className="bg-white">
      ...
      <section className="relative w-full">
        ...
        <a
          ...
          className="absolute font-serif text-black border border-black rounded-full"
          style={{
            top: "55%",
            right: "6%",
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-5 aspect-[3/2] flex flex-col justify-center">
            ...
            <div className="bg-white rounded-lg p-5 aspect-square flex flex-col justify-center">
